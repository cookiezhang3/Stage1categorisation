...
from catOptim_plt import CatOptim
...
def main(opts):
    ...
    for nCats in cats:
        optimiser = CatOptim(sigWeights, vbfM, [vbfV], bkgWeights, dataM, [dataV], nCats, ranges, names)
        ...
        optimiser.optimise(1, opts.nIterations) #set lumi to 1 as already scaled when loading in
